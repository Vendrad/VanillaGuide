...
-----------58-58 Eastern Plaguelands
	...
	[10006] = {
		...
		items = {
			...
			[10] = { str = "Go to 45,34 and loot the termite mounds here for 'A Plague Upon Thee pt.1' until you get 100 termites, also kill ghouls for 'Defenders of Darrowshire'", x = 45, y = 34, zone = "Eastern Plaguelands" },
			[11] = { str = "Go to 71,16 and kill Infiltrator Hameya for 'Hameya's Plea'", x = 71, y = 16, zone = "Eastern Plaguelands" },
			[12] = { str = "Go to the lake at 71,33 and grab the flag next to the cage (it’s hard to see and laying flat' for 'Of Lost Honor'", x = 71, y = 33, zone = "Eastern Plaguelands" },
