...
------------58-59 Western Plaguelands
	...
	[10007] = {
		...
		items = {
			...
			[18] = { str = "Hand in 'Marauders of Darrowshire' at Light’s Hope Chapel. Take the followup to Chromie and finally accept 'Battle of Darrowshire'. Do this whenever you can find a group for it" },
			[19] = { str = "Hearth to IF" },
			[20] = { str = "Go to the throne room at 43,52 and accept 'An Earnest Proposition' (pick your class from the list)", x = 43, y = 52, zone = "Ironforge" },
			[21] = { str = "Fly to Menethil and boat to Auberdine, fly to Darnassus" },
			[22] = { str = "Go to 35,8 on the 2nd floor and turn in 'Glyphed Oaken Branch'", x = 35, y = 8, zone = "Darnassus" },
			[23] = { str = "Fly to Everlook" },
		}
	},
