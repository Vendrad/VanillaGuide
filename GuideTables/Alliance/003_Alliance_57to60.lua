...
------------58-59 Western Plaguelands
	...
	[10007] = {
		...
		items = {
			...
			[18] = { str = "Fly to Light’s Hope Chapel. Hand in 'Heroes of Darrowshire'. Accept 'Marauders of Darrowshire'" },
			[18] = { str = "Kill Scourge Champions just North of Light’s Hope Chapel and into The Noxious Glade at 80,43. They drop Fetid Skulls which you can use the Mystic Crystal on for 'Marauders of Darrowshire'. This is a serious grind!" },
