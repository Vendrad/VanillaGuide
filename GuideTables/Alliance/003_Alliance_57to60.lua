...
----------- Burning Steppes
	[10002] = {
		...
		items = {
			...
			[23] = { str = "Fly back to Lakeshire and go to the townhall at 29,44 and turn in 'The True Masters pt.4' accept 'The True Masters pt.5'", x = 29, y = 44, zone = "Redridge Mountains" },
			[24] = { str = "Fly to the Burning Steppes and turn in 'The True Masters pt.5' when you land and accept 'The True Masters pt.6'" },
			[25] = { str = "Run up to 64,23 and listen to ragged john then run back to 84,68 and turn in 'The True Masters pt.6'. Accept 'Marshall Windsor'", x = 64, y = 23, zone = "Burning Steppes" },
			[26] = { str = "Hearth to IF" },
			[27] = { str = "Go to the thrown room at 38,55 and turn in 'The Smoldering Ruins of Thaurissan pt.2'", x = 38, y = 55, zone = "Ironforge" },
			[28] = { str = "Find the wandering dwarf Courier Hammerfall by running clockwise around IF and accept 'A Call To Arms: The Plaguelands!'" },
			[29] = { str = "Fly to Chillwind Camp, Western Plaguelands" },
		}
	},
...
------------56-57 Western Plaguelands
	...
	[10003] = {
		...
		items = {
			...
			[4] = { str = "Save the tokens until I say to hand em in" },
			[5] = { str = "Go NE to around 49,79 and accept 'Little Pamela' from Marlene Redpath.'" },
			[6] = { str = "Grind the ghouls here until you get enough for 'Clear The Way'", x = 51, y = 78, zone = "Western Plaguelands" },
			[7] = { str = "Go back to Chillwind Camp at 42,84 and turn in 'Clear The Way'. Accept 'All Along the Watchtowers' and 'The Scourge Cauldrons'", x = 42, y = 84, zone = "Western Plaguelands" },
			[8] = { str = "Turn around and turn in 'The Scourge Cauldrons'. Accept 'Target: Felstone Field'" },
			[9] = { str = "Go back NE to 48,72 and go over the bridge", x = 48, y = 72, zone = "Western Plaguelands" },
			[10] = { str = "Just in the town on the left at 47,71 is the 4th tower for 'All Along the Watchtowers', there are elites inside but you can stand out of LOS on the edge and mark the doors easily", x = 47, y = 71, zone = "Western Plaguelands" },
			[11] = { str = "1st tower West of here at 40,71. 2nd tower NE of here at 42,66. 3rd tower NE of here at 44,63. Just behind this tower." },
			[12] = { str = "Go NW to 37,56 to Felstone field, kill Cauldron Lord Bilemaw for his cauldron key. Then go right click the cauldron and turn in 'Target: Felstone Field' accept 'Return to Chillwind Camp'", x = 37, y = 56, zone = "Western Plaguelands" },
			[13] = { str = "Theres 2 houses on the NE side of the field at 38,54, enter the northern house and go upstairs. Accept 'Better Late Than Never pt.1'", x = 38, y = 54, zone = "Western Plaguelands" },
			[14] = { str = "Go in the barn next door and grab the box on the floor and turn in 'Better Late Than Never pt.1' accept 'Better Late Than Never pt.2'" },
			[15] = { str = "Run back to Chillwind Camp at 42,84 and turn in 'All Along the Watchtowers'. Accept 'Scholomance'.", x = 42, y = 84, zone = "Western Plaguelands" },
			[16] = { str = "Turn in 'Scholomance' just behind him, accept 'Skeletal Fragments'. Bones for this will take a while and drop off any skeletons." },
			[17] = { str = "Near the FP turn in 'Return to Chillwind Camp', accept 'Target: Dalson's Tears'" },
			[18] = { str = "Go up to 46,52 to Dalson’Tears, kill Cauldron Lord Malvinious for his cauldron key. Then go right click the cauldron and turn in 'Target: Dalson's Tears' accept 'Return to Chillwind Camp'", x = 46, y = 52, zone = "Western Plaguelands" },
			[19] = { str = "Enter the barn here at 47,50 and Touch the diary on the floor and complete it, another quest that isn’t a quest.", x = 47, y = 50, zone = "Western Plaguelands" },
			[20] = { str = "Go behind the barn and look for a Wandering Skeleton and get Dalson Outhouse Key off of him. Use this to open the outhouse back here and kill Farmer Dalson and get his Dalson Cabinet Key. Use the key on the locked cabinet upsairs in the house now at 47,49 next to the barn and complete the quest 'Locked Away'", x = 47, y = 49, zone = "Western Plaguelands" },
			[21] = { str = "Go back to Chillwind Camp at 42,84 and turn in 'Return to Chillwind Camp', accept 'Target: Writhing Haunt'", x = 42, y = 84, zone = "Western Plaguelands" },
			[22] = { str = "Hearth to IF then fly to SW" },
			[23] = { str = "Go to the building at 48,30 on the 2nd floor of the cathedral area and turn in 'Better Late Than Never pt.2' accept 'Good Natured Emma'", x = 48, y = 30, zone = "Stormwind" },
			[24] = { str = "Emma travels between the cathedral and the trade district, find her and turn in 'Good Natured Emma' accept 'Good Luck Charm'" },
			[25] = { str = "Go into the keep at 78,17 and accept 'The First and the Last'", x = 78, y = 17, zone = "Stormwind" },
			[26] = { str = "Go to 75,79 and turn in 'The First and the Last', accept 'Honor the Dead' then turn it right back in, accept 'Flint Shadowmore'", x = 75, y = 79, zone = "Stormwind" },
			[27] = { str = "Fly back to WPL" },
			[28] = { str = "In front of the house turn in 'Flint Shadowmore' accept 'The Eastern Plagues'" },
			[29] = { str = "Go back to Felstone field to the house upstairs at 38,54 and turn in 'Good Luck Charm'. Accept 'Two Halves Become One'. Go outside and look for a jabbering ghoul. You can’t miss him he carry’s a pitchfork. Keep clearing in front of the house until you find him. This will give you a good time to get those skeletal fragments", x = 38, y = 54, zone = "Western Plaguelands" },
			[30] = { str = "Combine the halves and go back upstairs and turn in 'Two Halves Become One'" },
			[31] = { str = "Go SE to 53,65 to Writhing Haunt, kill Cauldron Lord Razarch for his cauldron key. Then go right click the cauldron and turn in 'Target: Writhing Haunt' accept 'Return to Chillwind Camp'", x = 53, y = 65, zone = "Western Plaguelands" },
			[32] = { str = "In the house at 54,65 accept 'The Wildlife Suffers Too pt.1' now go north of the haunt and kill the diseased wolves. Don’t go any farther east to find these just go North, maybe NW some.", x = 54, y = 65, zone = "Western Plaguelands" },
			[33] = { str = "Go back to 54,65 and turn in 'The Wildlife Suffers Too pt.1' accept 'The Wildlife Suffers Too pt.2'", x = 54, y = 65, zone = "Western Plaguelands" },
			[34] = { str = "Go back to Chillwind Camp at 42,84 and turn in 'Return to Chillwind Camp' accept 'Target: Gahrron's Withering'", x = 42, y = 84, zone = "Western Plaguelands" },
			[35] = { str = "Go just north of the Writhing Haunt between the mountains on the map at, 52,56 and kill diseased grizzleys on your way down to 62,58 for 'The Wildlife Suffers Too pt.2'", x = 52, y = 56, zone = "Western Plaguelands" },
			[36] = { str = "Go NE to 62,58 to Gahrron’s Withering, kill Cauldron Lord Soulwrath for his cauldron key. Then go right click the cauldron and turn in 'Target: Gahrron's Withering' accept 'Return to Chillwind Camp'", x = 62, y = 58, zone = "Western Plaguelands" },
			[37] = { str = "Go back to 54,65 and turn in 'The Wildlife Suffers Too pt.2' accept 'Glyphed Oaken Branch'", x = 54, y = 65, zone = "Western Plaguelands" },
			[38] = { str = "If you haven’t finished 'Skeletal Fragments' yet go to the crypt at 54,79 and kill the skeletons until you have 15 fragments", x = 54, y = 79, zone = "Western Plaguelands" },
			[39] = { str = "Go back to Chillwind Camp at 42,84 and turn in 'Return to Chillwind Camp'", x = 42, y = 84, zone = "Western Plaguelands" },
			[40] = { str = "Turn around to the guy in front of the tent, and complete 'Mission Accomplished!'" },
			[41] = { str = "To your right turn in Skeletal Fragments. Accept 'Mold Rhymes With...' to continue getting your Scholomance key" },
			[42] = { str = "Send 2 Thorium Bars to yourself from a bank character." },
			[43] = { str = "Go to Menethil > Theramore > Gadgetzan" },
			[44] = { str = "Hand in 'Mold Rhymes With...' at the Southern entrance. Accept 'Fire Plume Forged'" },
			[45] = { str = "Take the 2 x Thorium Bars from the mailbox." },
			[46] = { str = "Fly to Marshall's Refuge, Un'Goro" },
			[47] = { str = "At 52,42 take the ramp up the mountain and stand at 48,48 to forge the key for 'Fire Plume Forged" },
			[48] = { str = "Go back to Chillwind Camp via hearthing to IF or Theramore > Menethil" },
			[49] = { str = "Hand in 'Fire Plume Forged'. Accept 'Araj's Scarab'." },
			[50] = { str = "Accept 'Alas, Andorhal'" },
			[51] = { str = "From this point on kill Araj The Summoner at 45,69 for 'Araj's Scarab' and 'Alas, Andorhal' whenever you are able to get a group for it" },
			[52] = { str = "Run east to 70,50 and enter the Eastern Plaguelands (EPL)", x = 70, y = 50, zone = "Western Plaguelands" },
		}
	},
...
-----------58-58 Eastern Plaguelands
	...
	[10006] = {
		...
		items = {
			...
			[6] = { str = "Turn in 'Brother Carlin' accept 'Villains of Darrowshire'" },
			[7] = { str = "Go down to 79,63 and turn in 'Zaeldarr the Outcast'", x = 79, y = 63, zone = "Eastern Plaguelands" },
			[8] = { str = "Go down just North of Corin’s Crossing to 53,65 and grab the sword for 'Villains of Darrowshire'. It’s down in the scar. Don’t forget to do some of 'Defenders of Darrowshire' at Corin’s. Just get what you can", x = 53, y = 65, zone = "Eastern Plaguelands" },
			...
			[10] = { str = "Go NE to around 65,41 and kill the zombies for part of 'Defenders of Darrowshire'. There are quite a lot here; you could probably finish the quest", x = 65, y = 41, zone = "Eastern Plaguelands" },
			[11] = { str = "Go to the lake at 71,33 and grab the flag next to the cage (it’s hard to see and laying flat' for 'Of Lost Honor'", x = 71, y = 33, zone = "Eastern Plaguelands" },
			[12] = { str = "Go to the lake at 71,16 and kill Infiltrator Hameya for 'Hameya's Plea'", x = 71, y = 16, zone = "Eastern Plaguelands" },
			[13] = { str = "Run West to 45,34 and loot the termite mounds here for 'A Plague Upon Thee pt.1' until you get 100 termites, also kill ghouls to finish up 'Defenders of Darrowshire'", x = 45, y = 34, zone = "Eastern Plaguelands" },
...
------------58-59 Western Plaguelands
	...
	[10007] = {
		...
		items = {
			...
			[6] = { str = "Go straight out of the tower over the mountains to 51,28 and turn in 'Unfinished Business pt.2' doing the 3rd part 'Unfinished Business pt.3' is optional. Some classes can do it easier than others. You have to run north to hearthglen and run up into the big tower in the center of town at 45,18 and look over the edge until it says complete.", x = 45, y = 18, zone = "Western Plaguelands" },
			[7] = { str = "Run back straight south over the mountains to 51,28 and turn in 'Unfinished Business pt.3'", x = 51, y = 28, zone = "Western Plaguelands" },
			[8] = { str = "Run into EPL and to the Mound of Dirt at 28,86 to hand in 'Hameya's Plea'", x = 28, y = 86, zone = "Eastern Plaguelands" },			
			[9] = { str = "Go up to 7,43 and turn in 'Of Lost Honor' accept 'Of Love and Family pt.1'", x = 7, y = 43, zone = "Eastern Plaguelands" },
			[10] = { str = "Go back to WPL and run/swim to the island Scholo is on at 65,75 and turn in 'Of Love and Family pt.1'. Accept 'Of Love and Family pt.2' which sends you to Stratholme Live (Archavist's Room) and finally ends with the blue reward quest 'In Dreams'", x = 65, y = 75, zone = "Western Plaguelands" },
			[11] = { str = "Go back to Chillwind Camp at 43,84 and turn in 'A Plague Upon Thee pt.3'", x = 43, y = 84, zone = "Western Plaguelands" },
			[12] = { str = "Now you want to get friendly with Argent Dawn. Do 'Alas, Andorhal' if you can find a group, it’s not that hard but can take 5-10 people. This will give you an easy 8300 xp." },
			[13] = { str = "Now you want to go up to andorhal and just grind until you’re friendly, once you’re friendly go back to Chillwind Camp and turn in all your scourge tokens. This allows you to buy mana biscuits which restore mana and health and more than food can" },
			[14] = { str = "Hearth to IF" },
			[15] = { str = "Go to the throne room at 43,52 and accept 'An Earnest Proposition' (pick your class from the list)", x = 43, y = 52, zone = "Ironforge" },
			[16] = { str = "Fly to Menethil and boat to Auberdine, fly to Darnassus" },
			[17] = { str = "Go to 35,8 on the 2nd floor and turn in 'Glyphed Oaken Branch'", x = 35, y = 8, zone = "Darnassus" },
			[18] = { str = "Fly to Everlook" },
		}
	},
