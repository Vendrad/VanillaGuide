...
------------58-59 Western Plaguelands
	...
	[10007] = {
		...
		items = {
			...
			[7] = { str = "Run north to hearthglen and up the big tower immediately inside the front gate at 45,18. Run to the edge facing the town until it says 'Unfinished Business pt.3' is complete", x = 45, y = 18, zone = "Western Plaguelands" },
 			[8] = { str = "Collect Libram for 'Heroes of Darrowshire' at 42,19. The elites should be soloable, pull methodically and watch out for mobs behind corners. If you get two in a pull there should be range to kite until the second loses aggro, but mind the roaming Lord (61+). The mobs have a fairly long respawn timer which helps", x = 42, y = 19, zone = "Western Plaguelands" },
 			[9] = { str = "Run back straight south over the mountains to 51,28 and turn in 'Unfinished Business pt.3'", x = 51, y = 28, zone = "Western Plaguelands" },
 			...
 			[11] = { str = "Collect Shield for 'Heroes of Darrowshire' at 64,57. There are a lot of mobs in this area but the shield is outside the house and all in all pretty easy to get to", x = 64, y = 57, zone = "Western Plaguelands" },
			...
			[16] = { str = "Fly to Light’s Hope Chapel. Hand in 'Heroes of Darrowshire'. Accept 'Marauders of Darrowshire'" },
			[17] = { str = "Kill Scourge Champions just North of Light’s Hope Chapel and into The Noxious Glade at 80,43. They drop Fetid Skulls which you can use the Mystic Crystal on for 'Marauders of Darrowshire'. This is a serious grind!" },
			[18] = { str = "Head back to Light's Hope Chapel and hand in 'Marauders of Darrowshire'. Accept 'Return To Chromie' and fly to Chillwind Camp" },
			[19] = { str = "Go back to the building that looks like an inn at 39,68 in Andorhal. Hand in 'Return to Chromie' upstairs. Accept 'Battle of Darrowshire'. Do this whenever you can find a group for it" },
			[20] = { str = "Hearth to IF" },
			[21] = { str = "Go to the throne room at 43,52 and accept 'An Earnest Proposition' (pick your class from the list)", x = 43, y = 52, zone = "Ironforge" },
			[22] = { str = "Fly to Menethil and boat to Auberdine, fly to Darnassus" },
			[23] = { str = "Go to 35,8 on the 2nd floor and turn in 'Glyphed Oaken Branch'", x = 35, y = 8, zone = "Darnassus" },
			[24] = { str = "Fly to Everlook" },
		}
	},
